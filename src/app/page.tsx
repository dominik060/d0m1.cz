      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[80rem] flex-col gap-0 border-x-2 border-current text-current">
        <Header className="h-screen">
          <div className="flex h-[80%] flex-col items-center justify-center text-center">
            <h1 className="font-hero bg-gradient-apple bg-clip-text text-h1 font-black text-transparent">
              Forming Tomorrow's
              <br />
              Digital Landscape.
            </h1>
        ...
        <div className="max-w-full overflow-hidden px-4">
          ...
          itaque esse sed, incidunt amet quod nihil repudiandae dolores
          quibusdam accusantium vero consectetur quisquam qui labore. Quo
          veritatis autem, non nam, deleniti eum et voluptas culpa quaerat ex,
          id aliquam quia ducimus dicta. Inventore corrupti nesciunt
          exercitationem molestiae, fuga accusamus ipsa odit placeat quos, natus
          culpa? Eligendi, odio praesentium ratione eius laudantium vitae
          sapiente aspernatur voluptate aperiam ex recusandae voluptatum, est
          similique. Ducimus, doloremque facere temporibus praesentium
          accusantium a, provident similique repudiandae excepturi mollitia
          perspiciatis dignissimos! Ratione ipsa, sed aperiam atque quo magnam
          voluptas, nisi, hic saepe consectetur quae perspiciatis placeat
          nostrum. Corrupti reprehenderit voluptas numquam placeat dolores sit
          tempora, excepturi quos tenetur accusantium, sunt vel!
        </div>
      </div>
    </main>
  );
