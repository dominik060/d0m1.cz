...
export default function ContactCard({
  ...
  return (
    <Link
      ...
      className="card group/card dark:before:bg-before-dark dark:after:bg-after-dark before:bg-before-light after:bg-after-light relative rounded-lg bg-black/20 p-[2px] before:absolute before:left-0 before:top-0 before:z-30 before:h-full before:w-full before:rounded-[inherit] before:opacity-0 before:duration-500 after:absolute after:left-0 after:top-0 after:z-10 after:h-full after:w-full after:rounded-[inherit] after:opacity-0 after:duration-500 hover:before:opacity-100 group-hover/board:after:opacity-100 dark:bg-white/20"
    >
